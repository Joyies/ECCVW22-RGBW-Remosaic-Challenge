...
import models.stdrunet.drunet_block as B
import numpy as np
...
class UNetRes(nn.Module):
    def __init__(self, in_nc=1, out_nc=1, nc=[64, 128, 256, 512], nb=4, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose', bias=True):
...
if __name__ == '__main__':
    ...
    mosaic_lrn  = torch.rand(1,1,128,128)
    net = create_model(mosaic_lrn)
    print(sum(p.numel() for p in net.parameters()))
    # with torch.no_grad(): 32650753
    #     y = net(mosaic_lrn)
    # print(y.size())